          ...
          <div className="room-list">
            ...
            {rooms.map((room) => (
              <button key={room.roomCode} className="room-row" onClick={() => setRoomCode(room.roomCode)}>
                <span><strong>{room.roomName}</strong><small>{room.gameId === "commercial-hub" ? "商都開発" : room.gameId === "ooishi-territory" ? "大石のテリトリー" : "ポンはいない"} ・ {room.playerCount}/{room.maxPlayers}人</small></span>
